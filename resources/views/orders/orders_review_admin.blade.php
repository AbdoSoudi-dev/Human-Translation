            ...
            <table class="table">
                ...
                @forelse($orders as $key => $order)
                        ...
                        <td class="text-center">
                            @if($order->payment && $order->payment->status == "done" && !$order->translated_file)
                                <button type="button" class="btn-sm btn-primary"
                                        onclick="processOrder('{{ $order->percent }}','{{ $order->id }}')"
                                        data-bs-toggle="modal" data-bs-target="#processOrder">
                                    Edit process
                                </button>
                            @endif
                        </td>
                    ...
                    <tr  class="text-center">
                        ...
                        <td colspan="{{ $isTranslatedFiles && $orderDeliverAt ? "11"
                                    : ($isTranslatedFiles || $orderDeliverAt ?"10" : "9") }}"
                ...
                @empty
                    <tr>
                        <td
                            colspan="{{ $isTranslatedFiles && $orderDeliverAt ? "11"
